...
<blockquote>
<form name="form1" action="detalhamento30032017_financeiro.php" method="POST" style="padding-top:40px;">
...
// INICIO DA CONSULTA PERSONALIZADA
   ...
   @mysql_select_db($db);//selecione o banco de dados
           ...
           $sqltudo = mysql_query("SELECT * FROM `banco_horas` where NOME = '$usuario_consulta' ORDER BY id")  or die(mysql_error()); 
