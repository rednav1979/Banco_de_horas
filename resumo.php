...
$horafin=0;
   ...
   @mysql_select_db($db);//selecione o banco de dados
           $sqltudo = mysql_query("SELECT * FROM banco_horas where usuario = 'vanderlei' ORDER BY id")  or die(mysql_error());
...
print '<i>';
print 'Calculo de Horas: Vanderlei Clemente';
print '</i>';
...
$horafin=0;
   include "sql.php";//conexão com o banco de dados   
   @mysql_select_db($db);//selecione o banco de dados
           $sqltudo = mysql_query("SELECT * FROM banco_horas where usuario = 'heitor' ORDER BY id")  or die(mysql_error());
           $colunas = mysql_num_rows($sqltudo);
