...
$horafin=0;
   ...
   @mysql_select_db($db);//selecione o banco de dados
           ...
           $sqltudo = mysql_query("SELECT * FROM banco_horas where NOME = 'THISBE' ORDER BY data_criacao")  or die(mysql_error());
...
$horafin=0;
   ...
   @mysql_select_db($db);//selecione o banco de dados
           ...
           $sqltudo = mysql_query("SELECT * FROM banco_horas where NOME = 'SAFIRA' ORDER BY data_criacao")  or die(mysql_error());
           $colunas = mysql_num_rows($sqltudo);
...
$horafin=0;
   ...
   @mysql_select_db($db);//selecione o banco de dados
           ...
           $sqltudo = mysql_query("SELECT * FROM banco_horas where NOME = 'ISIS_CRUZ' ORDER BY data_criacao")  or die(mysql_error());
           $colunas = mysql_num_rows($sqltudo);
