...
$horafin=0;
   ...
   @mysql_select_db($db);//selecione o banco de dados
           ...
           $sqltudo = mysql_query("SELECT * FROM banco_horas where NOME = 'ANDREIA' ORDER BY data_criacao")  or die(mysql_error());
...
$horafin=0;
   ...
   @mysql_select_db($db);//selecione o banco de dados
           ...
           $sqltudo = mysql_query("SELECT * FROM banco_horas where NOME = 'MAURA' ORDER BY data_criacao")  or die(mysql_error());
           $colunas = mysql_num_rows($sqltudo);
...
$horafin=0;
   ...
   @mysql_select_db($db);//selecione o banco de dados
           ...
           $sqltudo = mysql_query("SELECT * FROM banco_horas where NOME = 'GERALDO' ORDER BY data_criacao")  or die(mysql_error());
           $colunas = mysql_num_rows($sqltudo);
...
$horafin=0;
   ...
   @mysql_select_db($db);//selecione o banco de dados
           ...
           $sqltudo = mysql_query("SELECT * FROM banco_horas where NOME = 'JEFFERSON_CAMILO' ORDER BY data_criacao")  or die(mysql_error());
           $colunas = mysql_num_rows($sqltudo);
