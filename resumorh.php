...
$horafin=0;
   ...
   @mysql_select_db($db);//selecione o banco de dados
           ...
           $sqltudo = mysql_query("SELECT * FROM banco_horas where NOME = 'JOICE' ORDER BY data_criacao")  or die(mysql_error());
...
$horafin=0;
   ...
   @mysql_select_db($db);//selecione o banco de dados
           ...
           $sqltudo = mysql_query("SELECT * FROM banco_horas where NOME = 'RAYSSA' ORDER BY data_criacao")  or die(mysql_error());
           $colunas = mysql_num_rows($sqltudo);
...
$horafin=0;
   ...
   @mysql_select_db($db);//selecione o banco de dados
           ...
           $sqltudo = mysql_query("SELECT * FROM banco_horas where NOME = 'CRISTINA' ORDER BY data_criacao")  or die(mysql_error());
           $colunas = mysql_num_rows($sqltudo);
...
$horafin=0;
   ...
   @mysql_select_db($db);//selecione o banco de dados
           ...
           $sqltudo = mysql_query("SELECT * FROM banco_horas where NOME = 'SIBELY' ORDER BY data_criacao")  or die(mysql_error());
           $colunas = mysql_num_rows($sqltudo);
...
$horafin=0;
   ...
   @mysql_select_db($db);//selecione o banco de dados
           ...
           $sqltudo = mysql_query("SELECT * FROM banco_horas where NOME = 'LORENA' ORDER BY data_criacao")  or die(mysql_error());
           $colunas = mysql_num_rows($sqltudo);
...
$horafin=0;
   ...
   @mysql_select_db($db);//selecione o banco de dados
           ...
           $sqltudo = mysql_query("SELECT * FROM banco_horas where NOME = 'PATRICIA_NUTINI' ORDER BY data_criacao")  or die(mysql_error());
           $colunas = mysql_num_rows($sqltudo);
...
$horafin=0;
   ...
   @mysql_select_db($db);//selecione o banco de dados
           ...
           $sqltudo = mysql_query("SELECT * FROM banco_horas where NOME = 'NATHÁLIA_PAGOTTO' ORDER BY data_criacao")  or die(mysql_error());
           $colunas = mysql_num_rows($sqltudo);
...
$horafin=0;
   ...
   @mysql_select_db($db);//selecione o banco de dados
           ...
           $sqltudo = mysql_query("SELECT * FROM banco_horas where NOME = 'ANDREZA' ORDER BY data_criacao")  or die(mysql_error());
           $colunas = mysql_num_rows($sqltudo);
...
$horafin=0;
   ...
   @mysql_select_db($db);//selecione o banco de dados
           ...
           $sqltudo = mysql_query("SELECT * FROM banco_horas where NOME = 'THIAGO' ORDER BY data_criacao")  or die(mysql_error());
           $colunas = mysql_num_rows($sqltudo);
